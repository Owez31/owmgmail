...
def count_numbers():
    for i in range(1, 10000):
        print(colored(f"Ugradylan Report: {i}", "red"))
        time.sleep(0.3)

# Create PyFiglet text
figlet_text = pyfiglet.figlet_format("owm report", font="standard")

# Print the PyFiglet text
print(colored(figlet_text,'blue'))

# Kullanıcıdan bir kullanıcı adı alın
user_input = input(colored('Gmaily ýazyň Meselem : kerimgay@gmail.com:', 'white'))
print(colored(f'Gmail ady :: {user_input}', 'green'))
time.sleep(1)
